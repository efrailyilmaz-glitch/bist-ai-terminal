...
function overview(){
  ...
  <div class="panel"><div class="panelHead"><div><h2>Risk & Rejim</h2><p>V3 rejim motoru veri geldikçe genişleyecek</p></div></div><div class="hero"><small>Aktif durum</small><b>${state.market.regime||'NÖTR'}</b><small>${state.market.mode||'LIVE / YAHOO'} · ${state.market.updated||''}</small></div></div></div>`;
}
function allStocks(){
